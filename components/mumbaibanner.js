                    ...
                    <div className="col-lg-12">
                      <div className="inner text-center">
                        <div className="section-title">
                          ...
                          Unlock Your Potential at London College Mumbai:
                          </span>
                        </div>
                  ...
                  <div className="row align-items-center">
                    <div className="col-lg-12">
                      <div className="inner text-center">
                        <div className="section-title">
                          <span className="subtitle bg-white-opacity d-inline-block">
                          Embrace Knowledge, Ignite Innovation - Welcome to London College Mumbai
                          </span>
                        </div>
                        {/* <h1 className="title w-700">
                  ...
                  <div className="row align-items-center">
                    <div className="col-lg-12">
                      <div className="inner text-center">
                        <div className="section-title">
                          <span className="subtitle bg-white-opacity d-inline-block">
                          Exploring Boundaries, Inspiring Futures - Experience Excellence at London College Mumbai
                          </span>
                        </div>
                        <h1 className="title w-700">

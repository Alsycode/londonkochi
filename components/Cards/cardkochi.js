          ...
          <div className="rbt-card variation-03 rbt-hover">
            <div className="rbt-card-img position-relative">
              ...
              <div className="position-absolute top-50 start-50 translate-middle">
                <div className="rbt-button-group">
                  <Link className="rbt-moderbt-btn" href={`/londoncollege-kochi/updates/${data.id}`}>
            ...
            <div className="rbt-card-body">
              <h6 className="rbt-card-title">
                <Link href={`/londoncollege-kochi/updates/${data.id}`}>{data?.attributes?.heading}</Link>
              </h6>
              <div className="rbt-card-bottom">
                <Link className="transparent-button" href={`/londoncollege-kochi/updates/${data.id}`}>
                  <i>
                    <svg
                      width="17"
                      height="12"

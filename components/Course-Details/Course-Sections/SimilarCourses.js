...
const SimilarCourses = ({ checkMatchCourses }) => {
  ...
  const check = checkMatchCourses;
  console.log("checkMatchCourses",check)
  return (
    <>
...
<div className="row g-5">
 {checkMatchCourses &&
  checkMatchCourses?.slice(0, 3)?.map((item, innerIndex) => ( 
    <div
    ...
    >
      <div className="rbt-card variation-01 rbt-hover">
        <div className="rbt-card-img">
          {/* <Link href={checkMatchCourses.link}> */}
            <Image
              src={item?.courseImg}
              width={355}
              height={244}
        ...
        <div className="rbt-card-body">
          ...
          <p className="rbt-card-text">{item?.shortDescription}</p>
